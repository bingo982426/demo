...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
  ...
  public SqlSessionFactory getSqlSessionFactory() {
    //当前数据源
    String currentDsName = DataSourceContextHolder.getDB();
   ...
   * Transaction Manager It also unwraps exceptions thrown by {@code Method#invoke(Object,
   * Object...)} to pass a {@code PersistenceException} to the {@code
  ...
  private class SqlSessionInterceptor implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      SqlSessionFactory sqlSessionFactory = CustomSqlSessionTemplate.this
      ...
      try {
        ...
        if (CustomSqlSessionTemplate.this.exceptionTranslator
            != null
